 ...
 <input name="cerrarSesion" type="submit" value="Cerrar Sesión" class="btn btn-primary btn-sm" style="margin-left:10px;"></div>
	...
	<div class="registro">
		<form method="post" action="usuario">
			<h1 style="font-size: 25px;  margin-top:30px; margin-bottom:30px" >Registro de Nuevo Administrativo</h1>
			...
			<br> <input name="btnNuevoUser" type="submit" value="Registrar" class="btn btn-primary btn-block btn-large">
