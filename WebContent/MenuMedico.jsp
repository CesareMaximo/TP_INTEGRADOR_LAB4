			...
			<div class="table-wrapper">
				<div style="padding-bottom: 0px;" class="table-title">
					<div class="row">
							 ...
							 <div class="col-md-6"><h1>Médicos</h1></div>
							 <div class="col-md-6 d-flex justify-content-end"> 
							<a style="height:38px;" href="ServletMedico?Nuevo=1" name="nuevoMedico" class="btn btn-primary btn-ml">Nuevo Médico</a></div>
			...
			<div class="modal-dialog modal-confirm">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>¿Desea eliminar el médico? Esta operación no se puede
							deshacer</p>
