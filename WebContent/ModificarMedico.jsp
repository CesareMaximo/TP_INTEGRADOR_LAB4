	...
	<div class="registro">
		<form action="ServletMedico" method="post">
			...
			<table class="formulario">
				...
				<tr><td><label>Fecha Nacimiento:</label></td><td><input id="datefield" name="txtFechaNac" type="date" class="inputForm" size="20" required value="${medico.fechaNacimiento}"></td></tr>
