...
public class TurnoDAOImpl implements TurnoDAO {
	...
	private static final String filtraFecha =  "SELECT T.idTurno, T.idMedico, T.Fecha, T.idPaciente, (SELECT PE.Nombre FROM Paciente PA"
			+ " INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteNombre,"
			+ " (SELECT PE.Apellido FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteApellido,"
			+ " (SELECT PE.DNI FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteDNI,"
			+ " T.idEstado, ES.NombreEstado, T.Hora, T.Observación,"
			...
			+ " LEFT JOIN PERSONA P ON P.DNI = PA.DNI "
			+ " LEFT JOIN ESTADOS ES ON T.idEstado = ES.idEstado "
			+ " WHERE T.Fecha = ? AND (SELECT P.Estado FROM medico AS M INNER JOIN Persona P ON P.DNI = M.DNI WHERE M.idMedico = T.idMedico) = 1 ORDER BY T.Fecha ASC";
	private static final String filtraEstado = "SELECT T.idTurno, T.idMedico, T.Fecha, T.idPaciente, (SELECT PE.Nombre FROM Paciente PA"
			+ " INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteNombre,"
			+ " (SELECT PE.Apellido FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteApellido,"
			+ " (SELECT PE.DNI FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteDNI,"
			+ " T.idEstado, ES.NombreEstado, T.Hora, T.Observación,"
			...
			+ " LEFT JOIN PERSONA P ON P.DNI = PA.DNI "
			+ " LEFT JOIN ESTADOS ES ON T.idEstado = ES.idEstado "
			+ " WHERE T.idEstado = ? AND (SELECT P.Estado FROM medico AS M INNER JOIN Persona P ON P.DNI = M.DNI WHERE M.idMedico = T.idMedico) = 1 ORDER BY T.Fecha ASC";
	private static final String filtraFechaEstado = "SELECT T.idTurno, T.idMedico, T.Fecha, T.idPaciente, (SELECT PE.Nombre FROM Paciente PA"
			+ " INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteNombre,"
			+ " (SELECT PE.Apellido FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteApellido,"
			+ " (SELECT PE.DNI FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteDNI,"
			+ " T.idEstado, ES.NombreEstado, T.Hora, T.Observación,"
			...
			+ " LEFT JOIN PERSONA P ON P.DNI = PA.DNI "
			+ " LEFT JOIN ESTADOS ES ON T.idEstado = ES.idEstado "
			+ " WHERE T.idEstado = ? AND T.Fecha = ? AND (SELECT P.Estado FROM medico AS M INNER JOIN Persona P ON P.DNI = M.DNI WHERE M.idMedico = T.idMedico) = 1 ORDER BY T.Fecha ASC";
	
	private static final String filtraFechaEstadoxM = "SELECT T.idTurno, T.idMedico, T.Fecha, T.idPaciente, (SELECT PE.Nombre FROM Paciente PA"
			+ " INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteNombre,"
			+ " (SELECT PE.Apellido FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteApellido,"
			+ " (SELECT PE.DNI FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteDNI,"
			+ " T.idEstado, ES.NombreEstado, T.Hora, T.Observación,"
			...
			+ " LEFT JOIN PERSONA P ON P.DNI = PA.DNI "
			+ " LEFT JOIN ESTADOS ES ON T.idEstado = ES.idEstado "
			+ " WHERE T.idEstado = ? AND T.Fecha = ?  AND T.idMedico = ?  AND (SELECT P.Estado FROM medico AS M INNER JOIN Persona P ON P.DNI = M.DNI WHERE M.idMedico = T.idMedico) = 1 ORDER BY T.Fecha ASC";
	
	private static final String filtraFechaxM = "SELECT T.idTurno, T.idMedico, T.Fecha, T.idPaciente, (SELECT PE.Nombre FROM Paciente PA"
			+ " INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteNombre,"
			+ " (SELECT PE.Apellido FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteApellido,"
			+ " (SELECT PE.DNI FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteDNI,"
			+ " T.idEstado, ES.NombreEstado, T.Hora, T.Observación,"
			...
			+ " LEFT JOIN PERSONA P ON P.DNI = PA.DNI "
			+ " LEFT JOIN ESTADOS ES ON T.idEstado = ES.idEstado "
			+ " WHERE T.Fecha = ? AND T.idEstado != 1  AND T.idMedico = ?  AND (SELECT P.Estado FROM medico AS M INNER JOIN Persona P ON P.DNI = M.DNI WHERE M.idMedico = T.idMedico) = 1 ORDER BY T.Fecha ASC";
	
	private static final String filtraEstadoxM = "SELECT T.idTurno, T.idMedico, T.Fecha, T.idPaciente, (SELECT PE.Nombre FROM Paciente PA"
			+ " INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteNombre,"
			+ " (SELECT PE.Apellido FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteApellido,"
			+ " (SELECT PE.DNI FROM Paciente PA INNER JOIN Persona PE ON PE.DNI = PA.DNI WHERE PA.idPaciente = T.idPaciente) AS PacienteDNI,"
			+ " T.idEstado, ES.NombreEstado, T.Hora, T.Observación,"
			...
			+ " LEFT JOIN PERSONA P ON P.DNI = PA.DNI "
			+ " LEFT JOIN ESTADOS ES ON T.idEstado = ES.idEstado "
			+ " WHERE T.idEstado = ?  AND T.idMedico = ?  AND (SELECT P.Estado FROM medico AS M INNER JOIN Persona P ON P.DNI = M.DNI WHERE M.idMedico = T.idMedico) = 1 ORDER BY T.Fecha ASC";
	...
	public ArrayList<Turno> filtroFechaEstado(int idEstado, Date fecha) {
		...
		try{
			statement = conexion.prepareStatement(filtraFechaEstado);
	...
	public ArrayList<Turno> filtroFecha(Date fecha) {
		...
		try{
			statement = conexion.prepareStatement(filtraFecha);
	...
	public ArrayList<Turno> filtroEstado(int idEstado) {
		...
		try{
			statement = conexion.prepareStatement(filtraEstado);
			statement.setInt(1, idEstado);
			resultSet = statement.executeQuery();
	...
	public ArrayList<Turno> filtroFechaEstado(int idEstado, Date fecha, int idMedico) {
		...
		try{
			statement = conexion.prepareStatement(filtraFechaEstadoxM);
			statement.setInt(1, idEstado);
			statement.setDate(2, fecha);
	...
	public ArrayList<Turno> filtroFecha(Date fecha, int idMedico) {
		...
		try{
			statement = conexion.prepareStatement(filtraFechaxM);
			statement.setDate(1, fecha);
	...
	public ArrayList<Turno> filtroEstado(int idEstado, int idMedico) {
		...
		try{
			statement = conexion.prepareStatement(filtraEstadoxM);
			statement.setInt(1, idEstado);
			statement.setInt(2, idMedico);
			resultSet = statement.executeQuery();
